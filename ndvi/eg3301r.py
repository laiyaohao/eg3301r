...
out_tiff_int16 = r'singapore_NDVI_INT16.tif'

# Set the output for a 32-bit floating point (-1 to 1)
out_tiff_float32 = r'singapore_NDVI_FLOAT32.tif'

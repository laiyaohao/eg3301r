...
before_ndvi = Open(r'town_area_ndvi_float32.tif') #input desired image file name into x
before_ndvi_band = before_ndvi.GetRasterBand(1)

# Open a after image and get its only band.
after_ndvi = Open(r'central_catchment_area_vs_urban_area_ndvi_float32.tif') #input desired image file name into y
